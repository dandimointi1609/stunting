...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 01 Des 2022 pada 14.59
...
INSERT INTO `t_pravelensi` (`id_pravelensi`, `id_puskes`, `total_balita`, `pendek`, `sangat_pendek`, `total_pendek_sangat`, `tgl_input`) VALUES
(7, 14, '139', '5', '1', '6', '2022-12-01');
...
--
ALTER TABLE `t_pravelensi`
  MODIFY `id_pravelensi` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
