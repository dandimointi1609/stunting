                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="basic-form">
                            <form action="{{ url('inputpravelensi/update/' .$pravelensi->id_pravelensi) }}" method="POST">
                                @csrf
                                @method('PUT')
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-6">
                                        <label  for="tgl_input"><b>Tanggal Inputan</b></label>
                                            <input type="date" class="form-control" id="tgl_input" placeholder="Masukan Tanggal Inputan" name="tgl_input" value="{{ $pravelensi->tgl_input }}"    >
                                    </div>       
                                </div>
