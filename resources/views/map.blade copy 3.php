            ...
            layer.on('click', (e)=>{
                $.getJSON('titik/lokasi/'+feature.properties.kd_kecamatan, function(detail){
                    $.each(detail, function(index){
                        ...
                        var html='<h6> Total Stunting : '+detail[index].total+'<h6>';
                            // html+='<h6> Total Stunting : '+detail[index].total+'<h6>';
                            html+='<h6> Pendek : '+detail[index].total_pendek+'<h6>';
                            html+='<h6> Sangat Pendek : '+detail[index].sangat_pendek+'<h6>';
                            // html+='<h6> Sangat Pendek : '+detail[index].nama_desa+'<h6>';
                                

                            html+='<h6> <button type="button"  id="tombol" class="btn btn-primary" data-toggle="modal" data-target="#basicModal">Grafik</button> <h6>';

                        // var html = new leafletMap.popup ({
                        //     offset:25
                        // }).setHTML(detail[index].nama_kecamatan).setMaxWidth("400px")
                                //    var html='<div style="width: 600px;"> <canvas id="myChart"></canvas> </div>';
