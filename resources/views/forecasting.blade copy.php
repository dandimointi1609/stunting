        ...
        <div class="row">
            <div class="col-12 ">
                <div class="card mb-1">
                    ...
                    <div class="row">
						<div class="col-sm-4 ">
							{{-- <h6 class="alert alert-info">Nilai alpha saat ini adalah :  @foreach ($forecasting as $f) <b>{{$f->nilai_alpha}}</b>@endforeach</h6> --}}
                            ...
                            <table class="table table-striped table-bordered zero-configuration">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ $row->bln_thn }}</td>
                                        <td>{{ $row->d_aktual}}</td>
                                        {{-- <td>{{ $item->sum('d_aktual')/2}}</td>
                                        <td>{{ $item->sum('d_aktual')/2-368}}</td> --}}
                        ...
                        <script>
							...
							var dataFirst = {
								label: "Aktual",
										...
										data: [@foreach ($prediksi as $bln)  "{{$bln->d_aktual}}", @endforeach],
								...
								var dataSecond = {
									...
									var speedData = {
										...
										labels: [@foreach ($prediksi as $bln)  "{{$bln->bln_thn}}", @endforeach],
