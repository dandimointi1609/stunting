    ...
    <header id="header" class="ex-2-header">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    {{-- <h1>Log In</h1> --}}
                   <p><img class="img-fluid" src="landing/images/LogoLogin.png" width="60%" alt="alternative"/></p> 
                    ...
                    <div class="form-container">
                        {{-- <form action="login"  method="post"> --}}
                            ...
                            <div class="form-group">
                                ...
                                <label class="label-control" for="email">{{ __('E-Mail Address') }}</label>
                            ...
                            <div class="form-group">
                            <button type="submit" class="form-control-submit-button" name="">{{ __('Login') }}</button>
                            </div>
